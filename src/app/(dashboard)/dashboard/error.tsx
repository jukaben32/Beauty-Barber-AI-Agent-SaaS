...
import { ButtonLink, SurfaceCard, SectionEyebrow } from '@/components/dashboard/shared'
      ...
      <SurfaceCard className="w-full max-w-xl p-8 text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <button
            type="button"
            onClick={reset}
            className="inline-flex items-center gap-2 rounded-full bg-[var(--brand)] px-5 py-3 text-sm font-bold text-white shadow-[0_14px_32px_rgba(21, 57, 142,0.22)] transition hover:-translate-y-0.5"
          >
