  ...
  return (
    <div className="grid min-h-screen place-items-center px-6 py-10">
      <SurfaceCard className="w-full max-w-xl p-8 text-center">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight text-[var(--text-strong)]">This business site does not exist yet</h1>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-xs uppercase tracking-[0.24em] text-[var(--text-muted)]">
          ...
          Published business sites load from the `sites/[slug]` route
        </div>
      </SurfaceCard>
    </div>
  )
