    ...
    <div className="relative overflow-hidden bg-[var(--page-bg)]">
      ...
      <main>
        <section id="producto" className="relative mx-auto mt-6 grid w-full max-w-7xl items-center gap-14 overflow-hidden rounded-[36px] border border-[var(--border-soft)] bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(247,240,231,0.92))] px-6 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-20">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(21, 57, 142,0.11),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(236,170,93,0.12),transparent_26%)]" />
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="relative">
              <SurfaceCard className="relative overflow-hidden p-6">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(21, 57, 142,0.14),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(236,170,93,0.12),transparent_24%)]" />
                <div className="relative flex min-h-[540px] flex-col gap-6">
                  ...
                  <div className="rounded-[24px] border border-[var(--border-soft)] bg-white/74 p-4 backdrop-blur-sm">
                    ...
                    <div className="ecg-line mt-4 h-10 rounded-[18px] border border-[var(--border-soft)] bg-[linear-gradient(90deg,rgba(21, 57, 142,0.05),rgba(21, 57, 142,0.16),rgba(21, 57, 142,0.05))]" />
                  </div>
                </div>
              </SurfaceCard>
            </div>
        ...
        <section className="border-t border-[var(--border-soft)] bg-[linear-gradient(180deg,rgba(255,253,248,0.72),rgba(245,239,230,0.98))]">
          <div className="mx-auto w-full max-w-7xl px-6 py-24 lg:px-8">
            <SurfaceCard className="relative overflow-hidden px-6 py-8 sm:px-8 sm:py-10">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(21, 57, 142,0.12),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(236,170,93,0.12),transparent_24%)]" />
